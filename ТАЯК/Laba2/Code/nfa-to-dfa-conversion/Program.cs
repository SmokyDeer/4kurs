...
namespace nfa_to_dfa_conversion
{
    public static class Program
    {
        ...
        private static string _filePath = "D:\\институт\\4 КУРС\\4kurs\\ТАЯК\\Laba2\\var1.txt";
        ...
        #region MyFunctions
        private static void MyFunction(string inputString)
        {
            //Timer.Start();
            FiniteAutomata automata = BuildAutomataFromFile(_filePath, FiniteAutomataType.NFA);
